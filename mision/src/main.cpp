 ...
 *
 * Just: "${PATH_TO_BINARY}/intel --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class intel : public RoboComp::Application
{
public:
	intel (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
int ::intel::run(int argc, char* argv[])
{
