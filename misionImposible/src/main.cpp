...
/** \mainpage RoboComp::mision
 *
 * \section intro_sec Introduction
 *
 * The mision component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/mision --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class mision : public RoboComp::Application
{
public:
	mision (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
int ::mision::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
